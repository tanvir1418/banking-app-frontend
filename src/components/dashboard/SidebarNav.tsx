  ...
  return (
    <div className="w-64 bg-white text-gray-800 flex flex-col min-h-screen border-r border-gray-200">
      ...
      <div className="p-4 mt-auto border-t border-gray-200">
        <Button
          variant="ghost"
          className="w-full flex items-center space-x-3 px-3 py-2.5 rounded-md text-sm font-medium text-gray-600 hover:bg-gray-100 hover:text-red-600 transition-colors justify-start group"
          onClick={signOut}
        >
